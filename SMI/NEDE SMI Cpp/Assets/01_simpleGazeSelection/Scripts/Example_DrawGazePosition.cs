...
public class Example_DrawGazePosition : MonoBehaviour
{
    private GameObject gazeVis;

    void Start()
    {
        gazeVis = (GameObject)Resources.Load("GazeVis");
    ...
    private void UpdateThePosition()
    {
        ...
        SMIGazeController.Instance.smi_getRaycastHitFromGaze(out hitInformation);
