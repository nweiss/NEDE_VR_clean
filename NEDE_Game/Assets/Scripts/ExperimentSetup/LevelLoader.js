...
function Start() {
	...
	//=====================================================
	// The startup screen is a 2D object and can't be loaded in 3D. This disables the startup screen from being sent to the oculus.
	VR.VRSettings.enabled = false;
	//=====================================================
	Debug.Log("entered level loader start");
	...
	Debug.Log("finished level loader start()");
}
...
function OnLevelWasLoaded() {
	...
	//02/01/2017
	VR.VRSettings.showDeviceView = false;
	Debug.Log("Started levelloader onlevelwasloaded()");
