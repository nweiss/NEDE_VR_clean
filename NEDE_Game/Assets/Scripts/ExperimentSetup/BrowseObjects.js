...
function Start() {	
	...
	objPosition = GetComponent.<Camera>().ScreenToWorldPoint(Vector3(GetComponent.<Camera>().pixelWidth*0.5, GetComponent.<Camera>().pixelHeight*0.5,distanceToObject));
	var wallPosition = GetComponent.<Camera>().ScreenToWorldPoint(Vector3(GetComponent.<Camera>().pixelWidth*0.5, GetComponent.<Camera>().pixelHeight*0.5,distanceToObject + 10));
...
function UpdateTexture() {	
	cubeObject.GetComponent.<Renderer>().material.mainTexture = objectArray[iObject];
	return;
}
