function [outputOrder,outputScore,isSelfTunedTarget] = RerankObjectsWithTag(objectList,iTargets,nSensitivity,graph_1)
...
[new_score, iSelfTunedTargets] = GTAM_eegwronglabels(targetInd,graph_1.gradient,graph_1.weight,graph_1.propm,options);
