function [y,w,v,fwdModel,y_level1,X,Y,T,Az] = RunHybridHdcaClassifier(data, truth, trainingwindowlength, trainingwindowoffset, cvmode, level2data, fwdModelData)

% v2 contains modifications by Neil Weiss
%   1) Modified to return the ROC curves and not just the AUC
% 7/17/2017
%
...
for foldNum=1:nFolds
    ...
    for jFold = 1:cv_fold.numFolds
        ...
        for iWin=1:nWindows
            ...
            isInWin = (iWin)+(0:trainingwindowlength-1);
